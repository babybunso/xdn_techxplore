		...
		<div class="card">
			<div class="card-close">
				<div class="card-buttons">
					<?php if ($this->acl->restrict('merchants.merchants.add', 'return')): ?>
						<a href="<?php echo site_url('merchants/merchants/form/add')?>" data-toggle="modal" data-target="#modal" class="btn btn-sm btn-primary btn-add" id="btn_add"><span class="fa fa-plus"></span> <?php echo lang('button_add')?></a>
					<?php endif; ?>
				</div>
			</div>
			...
			<div class="card-body">				
				...
				<th class="all"><?php echo lang('index_merchant'); ?></th>
				<th class="min-desktop"><?php echo lang('index_location'); ?></th>
