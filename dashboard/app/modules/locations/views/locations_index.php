		...
		<div class="card">
			<div class="card-close">
				<div class="card-buttons">
					<?php if ($this->acl->restrict('locations.locations.add', 'return')): ?>
						<a href="<?php echo site_url('locations/locations/form/add')?>" data-toggle="modal" data-target="#modal" class="btn btn-sm btn-primary btn-add" id="btn_add"><span class="fa fa-plus"></span> <?php echo lang('button_add')?></a>
					<?php endif; ?>
				</div>
			</div>
			...
			<div class="card-body">				
				...
				<th class="all"><?php echo lang('index_location'); ?></th>
				<th class="min-desktop"><?php echo lang('index_city'); ?></th>
